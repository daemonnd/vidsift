...
fvid1 = Video("This is a test video title", fake, fake, fake, fake)
...
fvid_emoji_1 = Video("This is a video with 😀😀😀😀😀😀😀", fake, fake, fake, fake)
fvid_emoji_2 = Video("This is a test video title with some emojis 😀😀", fake, fake, fake, fake)
fvid_emoji_3 = Video("This is a test video title with one emoji 😀", fake, fake, fake, fake)

fvid_clickbait_1 = Video("You won't believe what happened next! This is 100% not clickbait, easy money and FREE!", fake, fake, fake, fake)
fvid_clickbait_2 = Video("This containse some clickbait phrases but not all of them, trust me", fake, fake, fake, fake)
fvid_clickbait_3 = Video("This is a clickbait title with some clickbait phrases but not all of them, trust me", fake, fake, fake, fake)

fvid_uppercase_1 = Video("THIS IS A TEST VIDEO TITLE IN UPPERCASE", fake, fake, fake, fake)
fvid_uppercase_2 = Video("This is a Test Video Title with Some Uppercase Words", fake, fake, fake, fake)
fivid_uppercase_3 = Video("This is a test video title in lowercase", fake, fake, fake, fake)

fvid_ponctuation_1 = Video("This is a ??!!!punc!uat!on!!!....", fake, fake, fake, fake)
fvid_ponctuation_2 = Video("This is a test video title with some punctuation!?", fake, fake, fake, fake)
fvid_ponctuation_3 = Video("This is a test video title with no punctuation", fake, fake, fake, fake)
...
fvid_mixed_signals = Video("This is a video with CLICKBAIT but not all of them, trust me, and some emojis 😀😀!!!!", fake, fake, fake, fake)
ftranscript_mixed_signals1 = "This transcript contains some clickbait phrases but not all of them, trust me, and some emojis "
fvid_mixed_signals2 = Video("This is a test video title with some CLICKBAIT phrases but not all of them, trust me, and some emojis 😀😀", fake, fake, fake, fake)
...
fvid_mixed_signals3 = Video("This is a test video title with some CLICKBAIT phrases but not all of them, trust me, and some emojis 😀😀", fake, fake, fake, fake)
ftranscript_mixed_signals3 = "This transcript contains some clickbait phrases but not all of them, trust me, and some emojis "

fvid_short_title = Video("Short", fake, fake, fake, fake)
